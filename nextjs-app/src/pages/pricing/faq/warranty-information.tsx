  ...
  >
      ...
      <main className="py-10   text-[#1F211D]">
        <div className="container mx-auto bg-[#FFFFFE] border-[#EFEEED] border p-6  ">
          ...
          <p className="mt-4">Acoating.com is committed to the quality and durability of our finishes. Our Limited Lifetime Warranty reflects this commitment under certain conditions outlined below.</p>

          <section className="mt-8">
            <h2 className="text-xl font-semibold">Refinishing Limited Lifetime Warranty</h2>
            <p>Acoating.com guarantees to refinish at NO Charge (custom camouflage exempt) any firearm, including any disassembly and reassembly fees paid for on the initial repair, under the conditions stated by our policy and the manufacturer’s guidelines.</p>
          </section>

          <section className="mt-8">
            <h2 className="text-xl font-semibold">Scope of Warranty</h2>
            <p>The warranty covers the preparation and application of the product to prevent flaking, peeling, or cracking when applied according to the manufacturer&apos;s specifications. However, it is limited by the conditions of normal wear and tear, including, but not limited to, abrasions, damages, impacts, and modifications.</p>
          </section>

          <section className="mt-8">
            <h2 className="text-xl font-semibold">Items Not Covered</h2>
            <ul className="list-disc pl-5">
              <li>Peeling or flaking due to normal wear and tear, abrasion, damage, impacts, modifications, scratches, or misuse.</li>
          ...
          <p className="mt-8">This warranty does not cover failures in the coating caused by circumstances beyond our control. We stand behind the quality of our work and will address any issues related to the application process itself.</p>
