...
const BulkRushPricing: React.FC = () => {
    return (
        <div className="w-full px-4 py-6 bg-[#202b2d] mb-0">  {/* Full width and specific background color */}
            <div className="grid grid-cols-4 gap-4 text-center mx-auto max-w-7xl">  {/* Centered content with maximum width */}

                {/* Column 1: Average Wait Time */}
                <div className="flex flex-col justify-between bg-[#202b2d] p-4 h-full">
                    <div>
                        <img src="/nextjs_images/icons/bullet-icon.png" alt="Bullet Icon" className="mx-auto mb-2 w-33 h-6" />
...
<p className="text-sm text-[#d3d9df] italic">Timeframes may vary based on current workload. Opt for rush pricing for quicker service.  </p>
                    ...
                    <p className="text-[#d3d9df]">
Prepare accordingly and anticipate top-quality craftsmanship delivered within a practical timeframe.</p>
                </div>
                ...
                <div className="flex flex-col justify-between bg-[#202b2d] p-4 h-full">
                    <div>
                        ...
                        <p className="text-[#d3d9df]">Utilize our fast-track service for those times when you can&lsquo;t wait.</p>
                    </div>
