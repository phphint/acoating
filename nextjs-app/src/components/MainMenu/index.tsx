...
const MainMenu: React.FC = () => {
  ...
  return (
    <div className="custom-menu container mx-auto px-3 relative z-0 sticky-menu bg-[#7ac3bf] flex items-stretch justify-between text-white drop-shadow-xl menu-height"
